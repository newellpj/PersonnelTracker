...
<link rel="stylesheet" type="text/css" href="./presentationResources/css/loginSignup.css">
...
<button id="accordion" class="accordion responsive">  &nbsp;&nbsp;&nbsp; Click here to enlarge </button>
